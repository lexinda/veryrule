...
public abstract class RuleInvokerAbst{
	...
	public abstract <R extends RuleBo> void doRuleCondation(Map<String, Object> param,Map<R, Object> ruleCondations,RuleProxyHandler ruleProxyHandler,boolean isTest);
